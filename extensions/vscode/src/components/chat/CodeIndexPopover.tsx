...
export const CodeIndexPopover: React.FC<CodeIndexPopoverProps> = ({
    ...
    const handleMessage = (event: MessageEvent) => {
      if (event.data.type === "codeIndexSecretStatus") {
        ...
        const updateWithSecrets = (prev: LocalCodeIndexSettings): LocalCodeIndexSettings => {
          ...
          if (!prev.codebaseIndexOpenRouterApiKey || prev.codebaseIndexOpenRouterApiKey === SECRET_PLACEHOLDER) {
            updated.codebaseIndexOpenRouterApiKey = secretStatus.hasOpenRouterApiKey ? SECRET_PLACEHOLDER : "";
          }
  ...
  const progressPercentage = useMemo(
    () =>
      indexingStatus.totalItems > 0 ? Math.round((indexingStatus.processedItems / indexingStatus.totalItems) * 100) : 0,
        ...
        >
          ...
          <div className="p-4">
            ...
            <div className="mt-4">
              ...
              >
                <span
                  className={`codicon codicon-${isSetupSettingsOpen ? "chevron-down" : "chevron-right"} mr-1`}
                ></span>
                    ...
                    <>
                      <div className="space-y-2">
                        ...
                        <VSCodeTextField
                          ...
                          onInput={(e: any) => updateSetting("codebaseIndexOpenAiCompatibleBaseUrl", e.target.value)}
                      ...
                      <div className="space-y-2">
                        ...
                        <VSCodeTextField
                          ...
                          onInput={(e: any) => updateSetting("codebaseIndexOpenAiCompatibleApiKey", e.target.value)}
                    ...
                    <>
                      <div className="space-y-2">
                        ...
                        <VSCodeTextField
                          ...
                          onInput={(e: any) => updateSetting("codebaseIndexVercelAiGatewayApiKey", e.target.value)}
            ...
            <div className="mt-4">
              ...
              >
                <span
                  className={`codicon codicon-${isAdvancedSettingsOpen ? "chevron-down" : "chevron-right"} mr-1`}
                ></span>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <VSCodeButton
                        ...
                        onClick={() =>
                          updateSetting("codebaseIndexSearchMinScore", CODEBASE_INDEX_DEFAULTS.DEFAULT_SEARCH_MIN_SCORE)
                        }
                      >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <VSCodeButton
                        ...
                        title={t("settings:codeIndex.resetToDefault")}
                        onClick={() =>
                          updateSetting("codebaseIndexSearchMaxResults", CODEBASE_INDEX_DEFAULTS.DEFAULT_SEARCH_RESULTS)
                        }
                      >
                        <span className="codicon codicon-discard" />
                      </VSCodeButton>
