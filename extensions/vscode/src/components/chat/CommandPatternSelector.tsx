    ...
    <div className="border-t border-vscode-panel-border/50 bg-vscode-sideBar-background/30">
      ...
      >
        <div className="group flex items-center gap-2 cursor-pointer w-full text-left">
          <span className={cn("text-sm flex-1 group-hover:opacity-100", isExpanded ? "opacity-100" : "opacity-40")}>
                ...
                <div className="flex-1">
                  {editState.isEditing ? (
                    ...
                    >
                      ...
                      {item.description && (
                        <span className="text-vscode-descriptionForeground ml-2">- {item.description}</span>
                      )}
                    </div>
                  )}
                </div>
